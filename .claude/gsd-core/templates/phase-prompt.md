...
<!-- For checkpoint task examples and patterns, see @E:/Projecten/Cabofeira/.claude/gsd-core/references/checkpoints.md -->
...
See `E:/Projecten/Cabofeira/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `E:/Projecten/Cabofeira/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `E:/Projecten/Cabofeira/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
