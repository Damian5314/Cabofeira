...
- Usage: Reference from command with `@E:/Projecten/Cabofeira/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to E:/Projecten/Cabofeira/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to E:/Projecten/Cabofeira/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
