...
See E:/Projecten/Cabofeira/.claude/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using E:/Projecten/Cabofeira/.claude/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using E:/Projecten/Cabofeira/.claude/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from E:/Projecten/Cabofeira/.claude/gsd-core/templates/discovery.md
...
Use E:/Projecten/Cabofeira/.claude/gsd-core/templates/discovery.md.
