...
```
Agent(
  prompt="Read E:/Projecten/Cabofeira/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/Projecten/Cabofeira/.claude/gsd-core/templates/VALIDATION.md`
