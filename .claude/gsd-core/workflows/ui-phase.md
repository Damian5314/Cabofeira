...
```markdown
Read E:/Projecten/Cabofeira/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: E:/Projecten/Cabofeira/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read E:/Projecten/Cabofeira/.claude/agents/gsd-ui-checker.md for instructions.
