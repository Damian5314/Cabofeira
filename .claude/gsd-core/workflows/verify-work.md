...
<template>
@E:/Projecten/Cabofeira/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@E:/Projecten/Cabofeira/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `E:/Projecten/Cabofeira/.claude/gsd-core/workflows/transition.md`.
...
- Follow @E:/Projecten/Cabofeira/.claude/gsd-core/workflows/diagnose-issues.md
