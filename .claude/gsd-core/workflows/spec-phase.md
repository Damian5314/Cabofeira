...
```bash
INIT=$(node "E:/Projecten/Cabofeira/.claude/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @E:/Projecten/Cabofeira/.claude/gsd-core/templates/spec.md.
