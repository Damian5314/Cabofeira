...
@E:/Projecten/Cabofeira/.claude/gsd-core/references/thinking-models-research.md
...
```bash
node "E:/Projecten/Cabofeira/.claude/gsd-core/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
