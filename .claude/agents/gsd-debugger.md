...
<required_reading>
@E:/Projecten/Cabofeira/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@E:/Projecten/Cabofeira/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = E:/Projecten/Cabofeira/.claude
                  → checks E:/Projecten/Cabofeira/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = E:/Projecten/Cabofeira/.claude/gsd-core
                  → writes to E:/Projecten/Cabofeira/.claude/gsd-core/hooks/
...
@E:/Projecten/Cabofeira/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @E:/Projecten/Cabofeira/.claude/gsd-core/references/common-bug-patterns.md
