...
Reference full template: `E:/Projecten/Cabofeira/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/Projecten/Cabofeira/.claude/gsd-core/templates/state.md`.
