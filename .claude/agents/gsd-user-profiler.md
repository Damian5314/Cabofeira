...
<reference>
@E:/Projecten/Cabofeira/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `E:/Projecten/Cabofeira/.claude/gsd-core/references/user-profiling.md` to load:
